                        ...
                        <div class="product-gallery" wire:ignore>
                            <ul class="slides">
                                <li data-thumb="{{ asset('assets/images/products') }}/{{ $product->image }}">
                                    <img id="zoom_10" src="{{ asset('assets/images/products') }}/{{ $product->image }}"
                                        alt="{{ $product->name }}" />
                                </li>
                                @php
                                ...
                                @foreach($images as $image)
                                   @if($image)
                                        <li data-thumb="{{ asset('assets/images/products') }}/{{ $image }}">
                                            <img id="zoom_11" src="{{ asset('assets/images/products') }}/{{ $image }}"
                                                alt="{{ $product->name }}" />
                                        </li>
                                   @endif
                                @endforeach
                                                ...
                                                <div id="comment-20" class="comment_container">
                                                    ...
                                                    <div class="comment-text">
                                                        <div class="star-rating">
                                                            <span class="width-{{$orderItem->review->rating*20}}-percent">{{$orderItem->review->rating}}<strong class="rating">5</strong> out of 5</span>
                                                        </div>
                                                        <p class="meta">
