<div>
    <div class="container" style="padding: 30px 0;">
        ...
        @if($order->is_delivering_different)
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                    ...
                    <div class="panel-body">
                        <table class="table">
                            <tr>
                                <th>First Name</th>
                                <td>{{$order->delivering->firstname}}</td>
                                <th>Last Name</th>
                                <td>{{$order->delivering->lastname}}</td>
                            </tr>
                            <tr>
                                <th>Phone</th>
                                <td>{{$order->delivering->mobile}}</td>
                                <th>Email</th>
                                <td>{{$order->delivering->email}}</td>
                            </tr>
                            <tr>
                                <th>Line1</th>
                                <td>{{$order->delivering->line1}}</td>
                            <tr>
                                <th>City</th>
                                <td>{{$order->delivering->city}}</td>
                                <th>Province</th>
                                <td>{{$order->delivering->province}}</td>
                            </tr>
                            <tr>
                                <th>Country</th>
                                <td>{{$order->delivering->country}}</td>
                                <th>Address</th>
                                <td>{{$order->delivering->address}}</td>
                            </tr>
                        </table>
                    </div>
                </div>
